      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="flex justify-center mb-6">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/70 backdrop-blur border border-[#a5d6a7] text-[#2e7d32] text-xs font-semibold shadow-sm">
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl shadow-[#2e7d32]/10 border border-white/60 overflow-hidden">
            ...
            <div className="bg-linear-to-r from-[#1b5e20] to-[#2e7d32] px-8 pt-8 pb-7">
              ...
              <p className="text-[#a5d6a7] text-sm mt-1.5">
            ...
            <form onSubmit={handleSubmit} className="px-8 py-7 space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <label className="block text-xs font-semibold text-[#1b5e20] uppercase tracking-wider">
                    Password
                  </label>
                  <Link
                    href="/forgot-password"
                    className="text-xs text-[#2e7d32] font-semibold hover:text-[#1b5e20] underline underline-offset-2 transition-colors"
                  >
                    Forgot password?
                  </Link>
                </div>
              ...
              {/* <label className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 rounded border-[#a5d6a7] accent-[#2e7d32] cursor-pointer"
                />
                <span className="text-xs text-[#4a7a4a] font-medium">
